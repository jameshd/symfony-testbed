 ...
 */
final class Version20180522105014 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE notification (id INTEGER NOT NULL, user_id INTEGER NOT NULL, post_id INTEGER DEFAULT NULL, liked_by_id INTEGER DEFAULT NULL, seen BOOLEAN NOT NULL, discr VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('DROP INDEX IDX_DED1C292A76ED395');
        $this->addSql('DROP INDEX IDX_DED1C2924B89032C');
        $this->addSql('CREATE TEMPORARY TABLE __temp__post_likes AS SELECT post_id, user_id FROM post_likes');
        $this->addSql('DROP TABLE post_likes');
        $this->addSql('CREATE TABLE post_likes (post_id INTEGER NOT NULL, user_id INTEGER NOT NULL, PRIMARY KEY(post_id, user_id), CONSTRAINT FK_DED1C2924B89032C FOREIGN KEY (post_id) REFERENCES micro_post (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_DED1C292A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO post_likes (post_id, user_id) SELECT post_id, user_id FROM __temp__post_likes');
        $this->addSql('DROP TABLE __temp__post_likes');
